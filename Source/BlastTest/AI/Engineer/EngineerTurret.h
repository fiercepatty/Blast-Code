...
protected:
	...
	UPROPERTY(EditAnywhere,Category="AI Settings | Turret Settings")
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AI Settings | Turret Settings", meta = (AllowProtectedAccess = "true"))
