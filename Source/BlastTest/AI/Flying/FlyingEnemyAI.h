...
public:
	...
	/** boolean on whether or not the flyer is doing a incomplete path*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AI Settings | Flyer Settings", meta = (AllowProtectedAccess = "true"))
